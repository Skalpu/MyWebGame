...
<script>
	...
	var atakerzy = <?php echo json_encode($atakerzy); ?>;
	var obroncy = <?php echo json_encode($obroncy); ?>;
	
	if(atakerzy.length == 1)
	{
		
		//$("#atakerzy").find("#0").css("display","block");
		$("#atakerzy").find("#0").find(".imageContainer").css("width":"100px","height":"100px");
	}
	else if(atakerzy.length == 2)
	{
		
	}
	else if(atakerzy.length == 3)
	{
		
	}
	else if(atakerzy.length == 4)
	{
		
	}
	
	$("#atakerzy").css("display","block");
	//alert(atakerzy[0]['hp']);
	//alert(atakerzy.length);
